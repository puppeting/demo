...
class CustomizedProgressBar : View {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val round = mHeight / 2 //半径
        mPaint.color = resources.getColor(R.color.color_main_orangeAlpha) //设置边框背景颜色
        ...
        private get() {
            if (field == null) {
                field = LinearGradient(
                    0f, 0f, width.toFloat(), mHeight.toFloat(), intArrayOf(
                        mContext!!.resources.getColor(R.color.color_main_orange),
                        mContext!!.resources.getColor(R.color.color_main_orange)
