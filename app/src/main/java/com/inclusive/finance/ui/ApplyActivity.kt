...
class ApplyActivity : BaseActivity(), PresenterClick {
        ...
        viewBind =
            DataBindingUtil.setContentView<ActivityApplyBinding>(this, R.layout.activity_apply)
                .apply {
                    ...
                    data = viewModel
                    presenterClick = this@ApplyActivity
...
//        Watermark.instance?.show(this, "Fantasy BlogDemo")
        ...
        when (viewModel.businessType) {
            ...
            -> {
                ...
                bind?.data = viewModel
                bind?.presenterClick = this@ApplyActivity
                ...
                viewBind?.toolbar?.menu?.add(getString(R.string.userhelp))?.apply {
                    ...
                    actionView = TextView(this@ApplyActivity).apply {
                        setPadding(15)
                        ...
                        setOnClickListener {
                            val popup = PopupMenu(this@ApplyActivity, this)
...
//                            }
                                    R.id.item_account -> {
                                        if (accountPop == null) {
                                            accountPop = AccountPop2(this@ApplyActivity)
