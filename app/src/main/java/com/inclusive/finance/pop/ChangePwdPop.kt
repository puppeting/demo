...
import com.inclusive.finance.databinding.PopChangepwdBinding
import com.inclusive.finance.utils.StatusBarUtil

class ChangePwdPop(var mContext: Context?, val title: String, var listener: (confirm: Boolean) -> Unit) :
    DialogFragment(), View.OnClickListener {
    var confirmStr="确定"
    var cancelStr="取消"
    fun setCancelText(str: String): ChangePwdPop {
        cancelStr = str
        return this
    }

    fun setConfirmText(str: String): ChangePwdPop {
        confirmStr = str
        return this
    }
    ...
    lateinit var dataBind: PopChangepwdBinding
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View { //        dialog?.requestWindowFeature(Window.FEATURE_NO_TITLE)
        ...
        dataBind = PopChangepwdBinding.inflate(inflater, container, false)
