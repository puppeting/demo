package com.inclusive.finance.config
...
object Urls {
    ...
    //        var url = "https://192.168.3.31/jeecg-boot/"
//        var url = "http://192.168.3.91:8082/jeecg-boot/"
//        var url = "https://192.168.3.31/jeecg-boot1/"
//        var url = "https://192.168.3.31/jeecg-boot2/"
//        var url = "http://192.168.3.75:8010/jeecg-boot/"
//        var url = "http://192.168.3.75:8082/jeecg-boot/"
//        var url = "https://192.168.3.31/jeecg-boot3/"
//        var url = "http://192.168.3.110:8082/jeecg-boot/"
//        var url = "http://192.168.3.73:8020/jeecg-boot/"
        var url = "http://shenhe.xzjinqiao.com/api/"
//        var url = "http://88.108.35.110:8020/jeecg-boot/"
//        var url = "https://joinerbi.cn/jeecg-boot/"
//        var url = "http://66.108.95.111:9999/"
//    var url = "http://88.108.35.239:8020/phjr/"


//          var url = "http://66.108.95.111:9999/"
//        var url = "http://joinerbi.cn:3000/jeecg-fx/"
//        var url = "http://192.168.1.115:8888/jeecg-boot/"
//        var url = "https://phjr.fxrcb.com.cn/jeecg-boot/"
//        var url = "http://joinerbi.cn:3000/jeecg-boot/"
    /**
     *同步标准接口
     */
    val SyncPageList = url + "Standard/SyncPageList"
    /**
     *获取验证码
     */
     ...
     * 获取调查报告poc基本信息表
     */
    val getPOCDCBGBaseInfo = url + "ygxt/dcbg/previewDB"
    val savePOCDCBGBaseInfo = url + "ygxt/dcbg/edit"
     ...
     * poc 工商信息新增修改
     * */
    val get_preData_list = url + "ygxt/dcbg/preData"
    val get_preSave_list = url + "ygxt/dcbg/preSave"
    /**
     * 客户信息管理
     * */
    val get_khglKhxx_list = url + "khgl/khglKhxx/list"//客户信息列表
    val get_khglKhxx_ocr = url + "khgl/khglKhxx/ocr"//客户新增ocr
    val save_khglKhxx_ocradd = url + "khgl/khglKhxx/ocradd"//客户信息 新增 保存
    val get_khglKhxx_get = url + "khgl/khglKhxx/get"//
    val get_khglKhxx_Add = url + "khgl/khglKhxx/add"
    /**
     * 客户信息管理-查看评级
     * */
    val poc_get_khglKhpf_list = url + "khgl/khglKhpf/list"
    val poc_get_khglKhpf_preAdd = url + "khgl/khglKhpf/preAdd"
    val poc_get_khglKhpf = url + "khgl/khglKhpf/get"
    val poc_save_khglKhpf = url + "khgl/khglKhpf/add"
    val poc_get_khglZhpj = url + "khgl/khglZhpj/get"
    val poc_save_khglZhpj = url + "khgl/khglZhpj/add"
    val poc_flow_get_khgl_config = url + "khgl/flow/getConfiguration"
    val poc_flow_save_khgl_handleFlow = url + "khgl/flow/handleFlow"
    val poc_flow_get_khgl_getFlowHis = url + "khgl/flow/getFlowHis"
    val poc_get_pjzb = url + "khgl/khglZhpj/getPjZbpz"
    val poc_get_edpjzb  = url + "khgl/khglZhpj/getEdZbpz"
    /**
     * 授信项下
     * */
    val poc_get_sxxx_list = url + "sxxx/sxxx/list"
    val poc_get_sxxx_preAdd = url + "sxxx/sxxx/preAdd"
    val poc_save_sxxx_preAdd = url + "sxxx/sxxx/add"
    val poc_save_sxxx_sxlist = url + "sxxx/sxxx/sxlist"
    val poc_get_sxxx_get = url + "sxxx/sxxx/get"
    val poc_save_sxxx_edit = url + "sxxx/sxxx/edit"
    val poc_save_sxxx_getCodeValueByKeyPost = url + "ygxt/codeValue/getCodeValueByKeyPost"
    val poc_get_sxxx_mqjl_list = url + "sxxx/mqjl/list"
    val poc_save_sxxx_mqjl_add = url + "sxxx/mqjl/add"
    val poc_delete_sxxx_mqjl_delete = url + "sxxx/mqjl/delete"
    val poc_flow_get_sxxx_config = url + "sxxx/flow/getConfiguration"
    val poc_flow_save_sxxx_handleFlow = url + "sxxx/flow/handleFlow"
    val poc_flow_get_sxxx_getFlowHis = url + "sxxx/flow/getFlowHis"
    /**
     * 放贷申请
     * */
    val poc_get_fdsq_list = url + "sxxx/fdsq/list"
    val poc_get_fdsq_preAdd = url + "sxxx/fdsq/preAdd"
    val poc_save_fdsq_preAdd = url + "sxxx/fdsq/add"
    val poc_save_fdsq_sxlist = url + "sxxx/fdsq/sxlist"
    val poc_get_fdsq_get = url + "sxxx/fdsq/get"
    val poc_save_fdsq_edit = url + "sxxx/fdsq/edit"
    val poc_save_fdsqWtzf_edit = url + "sxxx/fdsqWtzf/list"
    /**
     * 合同登记
     * */
    val poc_get_htdj_list = url + "sxxx/htdj/list"
    val poc_get_htdj_preAdd = url + "sxxx/htdj/preAdd"
    val poc_save_htdj_preAdd = url + "sxxx/htdj/add"
    val poc_save_htdj_sxlist = url + "sxxx/htdj/sxlist"
    val poc_get_htdj_get = url + "sxxx/htdj/get"
    val poc_save_htdj_edit = url + "sxxx/htdj/edit"
    val poc_loginByFaceId = url + "sys/loginByFaceId"
}